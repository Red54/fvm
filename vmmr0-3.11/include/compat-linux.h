...
static inline int vmmr0_native_write_msr_safe(unsigned int msr,
...
static inline unsigned long long vmmr0_native_read_tsc(void)
{
	DECLARE_ARGS(val, low, high);
...
#define vmmr0_native_read_tsc		native_read_tsc
...
{
	panic("vmmr0 machine check!\n");
}

#else

#define vmmr0_do_machine_check do_machine_check
...
#define vmmr0_pt_regs_flags flags
#define vmmr0_pt_regs_cs cs
...
{
	set_debugreg(current->thread.vmmr0_compat_debugreg(0), 0);
	set_debugreg(current->thread.vmmr0_compat_debugreg(1), 1);
	set_debugreg(current->thread.vmmr0_compat_debugreg(2), 2);
	set_debugreg(current->thread.vmmr0_compat_debugreg(3), 3);
	set_debugreg(current->thread.vmmr0_compat_debugreg(6), 6);
	set_debugreg(current->thread.vmmr0_compat_debugreg(7), 7);
}
...
#else
#define vmmr0_check_tsc_unstable		check_tsc_unstable
#endif
...
#else
#define vmmr0_tboot_enabled	tboot_enabled
...
#else
#define vmmr0_pvclock_vcpu_time_info	pvclock_vcpu_time_info
#endif
...
#define vmmr0_i387_fxsave_struct	i387_fxsave_struct
#define vmmr0_xsave_struct	xsave_struct
#define vmmr0_thread_xstate	thread_xstate
...
#define vmmr0_compat_fpu			fpu
#define vmmr0_fpu_alloc			fpu_alloc
#define vmmr0_fpu_free			fpu_free
#define vmmr0_fpu_restore_checking	fpu_restore_checking
#define vmmr0_fpu_save_init		fpu_save_init
#define vmmr0_fpu_finit			fpu_finit

#define vmmr0_xstate_size			xstate_size

static inline void vmmr0_xstate_size_init(void)
{
}
...
#else /* >= 2.6.38 */
#define vmmr0_init_fpu	init_fpu
#endif /* >= 2.6.38 */
...
#define vmmr0_cpu_has_xsave	0
#else /* >= 2.6.28 */
#define vmmr0_cpu_has_xsave	cpu_has_xsave
#endif /* >= 2.6.28 */
...
#define vmmr0_cpu_has_amd_erratum	cpu_has_amd_erratum
#define vmmr0_amd_erratum_383	amd_erratum_383
...
#else
#define vmmr0_set_64bit		set_64bit
#endif
...
#else
#define vmmr0_boot_cpu_has	boot_cpu_has
#endif
...
#else /* >= 2.6.35 */
#define vmmr0_cpuid10_eax	cpuid10_eax
#endif
...
#else /* >= 2.6.36 */
#define vmmr0_cpuid10_edx	cpuid10_edx
#endif
...
static inline int vmmr0_memcmp(const void *cs, const void *ct, size_t count)
{
